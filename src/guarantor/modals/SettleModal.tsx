...
import { GuarantorEscrow, GuarantorEscrowSettlementInfo } from '../../../lib';
...
type SettleModalProps = {
  ...
  settlementInfo: GuarantorEscrowSettlementInfo;
};
...
> {
  ...
  async handleClick() {
    ...
    try {
      transaction = await this.props.guarantorEscrow.settle();
    } catch (err) {
      this.setState({
        ...this.state,
