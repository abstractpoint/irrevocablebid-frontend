...
import { SellerEscrow, SellerEscrowState, SellerEscrowContractInfo,
         SellerEscrowOfferInfo, SellerEscrowBidInfo, SellerEscrowSettlementInfo } from "../../lib";
...
const SellerViewButtons: {
...
}[] = [
  {
    ...
    isVisible: (state: SellerEscrowState) => { return state == SellerEscrowState.Created; },
    isComplete: (state: SellerEscrowState) => { return state >= SellerEscrowState.Deposited; },
  },
  {
    name: "Get Guarantor Link",
    modal: SellerViewModal.GuarantorLink,
    isVisible: (state: SellerEscrowState) => { return state == SellerEscrowState.Deposited; },
    isComplete: (state: SellerEscrowState) => { return state >= SellerEscrowState.Committed; },
  },
  {
  ...
  },
  {
    ...
    isVisible: (state: SellerEscrowState) => { return state == SellerEscrowState.Committed; },
    isComplete: (state: SellerEscrowState) => { return state >= SellerEscrowState.Listed; },
  },
  {
    name: "Fulfill Auction",
    modal: SellerViewModal.FulfillAuction,
    isVisible: (state: SellerEscrowState) => { return state == SellerEscrowState.Listed; },
    isComplete: (state: SellerEscrowState) => { return state >= SellerEscrowState.Executed; },
  },
  {
    name: "Settle",
    modal: SellerViewModal.Settle,
    isVisible: (state: SellerEscrowState) => { return state == SellerEscrowState.Executed; },
    isComplete: (state: SellerEscrowState) => { return state >= SellerEscrowState.Settled; },
  },
];
...
class SellerViewComponent extends React.Component<SellerViewProps, SellerViewState> {
  ...
  async instantiate(sellOrderData: string | null, buyOrderData: string | null) {
    ...
    const sellerEscrow = new SellerEscrow(this.props.context.provider, this.props.context.deployment, sellOrder, buyOrder);
  ...
  async refreshState() {
    ...
    const isOwner = (await isWalletConnected(this.props.context.provider)) && (await this.state.sellerEscrow.isOwner());
    ...
    return (
      <Container component="main" maxWidth="sm">
        <Paper variant="outlined">
          <Typography component="h1" variant="h5" align="center">Seller</Typography>
          <ContractInfo context={this.props.context} contractInfo={this.state.sellerEscrowInfo.contractInfo} />
          <OfferInfo context={this.props.context} offerInfo={this.state.sellerEscrowInfo.offerInfo} />
          <BidInfo context={this.props.context} bidInfo={this.state.sellerEscrowInfo.bidInfo} />
          <SettlementInfo context={this.props.context} settlementInfo={this.state.sellerEscrowInfo.settlementInfo} />
            ...
            {SellerViewButtons.map((button) => {
              return (
                <Grid container item alignItems="center" justify="center" xs={12} spacing={1}>
                  ...
                  <Grid item xs={2}>
                    {this.state.sellerEscrowInfo.state !== null && button.isComplete(this.state.sellerEscrowInfo.state) &&
        ...
        {this.state.sellerEscrow !== null && this.state.sellerEscrowInfo.offerInfo !== null &&
          <DepositModal open={this.state.modalOpen == SellerViewModal.Deposit}
        ...
        {this.state.sellerEscrow !== null &&
          <GuarantorLinkModal open={this.state.modalOpen == SellerViewModal.GuarantorLink}
                              onClose={() => { this.handleModalClose(); }}
                              sellerEscrow={this.state.sellerEscrow} />}
        {this.state.sellerEscrow !== null &&
          <ApproveGuarantorModal open={this.state.modalOpen == SellerViewModal.ApproveGuarantor}
                                 onClose={() => { this.handleModalClose(); }}
                                 context={this.props.context}
                                 sellerEscrow={this.state.sellerEscrow} />}
        {this.state.sellerEscrow !== null && this.state.sellerEscrowInfo.offerInfo && this.state.sellerEscrowInfo.bidInfo &&
          <StartAuctionModal open={this.state.modalOpen == SellerViewModal.StartAuction}
                             onClose={() => { this.handleModalClose(); }}
                             context={this.props.context}
                             sellerEscrow={this.state.sellerEscrow}
                             offerInfo={this.state.sellerEscrowInfo.offerInfo}
        ...
        {this.state.sellerEscrow !== null &&
          <FulfillAuctionModal open={this.state.modalOpen == SellerViewModal.FulfillAuction}
                               onClose={() => { this.handleModalClose(); }}
                               context={this.props.context}
                               sellerEscrow={this.state.sellerEscrow} />}
        {this.state.sellerEscrow !== null && this.state.sellerEscrowInfo.projectedSettlementInfo !== null &&
          <SettleModal open={this.state.modalOpen == SellerViewModal.Settle}
                       onClose={() => { this.handleModalClose(); }}
                       context={this.props.context}
                       sellerEscrow={this.state.sellerEscrow}
                       settlementInfo={this.state.sellerEscrowInfo.projectedSettlementInfo} />}
      </Container>
    );
  }
}
